...
describe('scopify', function () {
  ...
  it('should color blocks in non-strict mode', fixture('non-strict-blocks', {blockScope: true}));
  it('should color blocks in strict mode', fixture('strict-blocks', {blockScope: true}));
  ...
  it('should infer node from top-level global module.exports', fixture('node-module-exports', {levels: 'elevated'}));
  it('should infer node from top-level global module.exports property', fixture('node-module-exports-property', {levels: 'elevated'}));
  it('should infer node from top-level global exports property', fixture('node-exports-property', {levels: 'elevated'}));
  it('should infer node from top-level global require call', fixture('node-require', {levels: 'elevated'}));
  it('should not infer node from top-level local require call', fixture('node-local-require', {levels: 'unelevated'}));
  it('should not infer node from nested global require call', fixture('node-nested-require', {levels: 'unelevated'}));
});
